    ...
    <>
      <div className="flex items-center min-h-screen font-default p-4 bg-background lg:justify-center">
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white border-background-light bg-background-light md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            <h2 className="my-3 text-4xl font-bold tracking-wider text-center">
              LikeBook
            </h2>
            <p className="mt-6 font-normal text-center text-secondary md:mt-0">
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center">
              ...
              <Link href="/register">
                <a className="underline text-secondary">Get Started</a>
              </Link>
            </p>
          </div>
