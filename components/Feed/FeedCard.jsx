...
export default function FeedCard() {
  return (
    <>
      <section class=" flex items-center font-default justify-center px-4 ">
        <div className="rounded-xl my-16 border-border border-2 bg-white w-full md:w-3/3 lg:w-2/3">
          ...
          <div className="flex justify-between items-center text-white py-6 px-4 border-t">
            ...
            <div>
              <button className="inline px-4 py-3  hover:shadow-lg  rounded-md text-white bg-primary cursor-pointer">
                Post Your Message
              </button>
            </div>
          </div>
